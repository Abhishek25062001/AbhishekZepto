...
export const systemRoleSeedMatrix: UpsertSystemRoleInput[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      createPermissionCode(AUTH_PERMISSION_RESOURCE.DELIVERY, AUTH_PERMISSION_ACTION.READ),
      createPermissionCode(AUTH_PERMISSION_RESOURCE.DELIVERY, AUTH_PERMISSION_ACTION.UPDATE),
      createPermissionCode(
        AUTH_PERMISSION_RESOURCE.DELIVERY,
        AUTH_PERMISSION_ACTION.UPDATE_STATUS,
      ),
      ...
      createPermissionCode(AUTH_PERMISSION_RESOURCE.REPORTS, AUTH_PERMISSION_ACTION.EXPORT),

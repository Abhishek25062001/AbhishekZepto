...
function NewAssignmentAlert() {
    ...
    const viewModel = (0, new_assignment_alert_util_1.getNewAssignmentAlertViewModel)(lastAssignmentEvent);
    if (!viewModel) {
        return null;
    }
    return (<react_native_1.TouchableOpacity activeOpacity={0.86} onPress={() => navigation.navigate(viewModel.navigationTarget)} style={styles.card}>
      ...
      <react_native_1.View style={styles.detailRow}>
        ...
        <react_native_1.Text style={styles.value}>{viewModel.assignmentLabel}</react_native_1.Text>
      </react_native_1.View>
      <react_native_1.View style={styles.detailRow}>
        <react_native_1.Text style={styles.label}>Order</react_native_1.Text>
        <react_native_1.Text style={styles.value}>{viewModel.orderId}</react_native_1.Text>
      </react_native_1.View>
      <react_native_1.View style={styles.detailRow}>

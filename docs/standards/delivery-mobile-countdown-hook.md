# Delivery Mobile Countdown Hook

## Goal

Use a shared mobile countdown hook for OTP expiry and resend timers in Delivery
Agent App instead of duplicating interval logic inside auth screens.

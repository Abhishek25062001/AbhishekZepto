  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--color-text-secondary)' }}>
        Manage your vendor sign-ins. Tokens and secrets are never displayed on this page.
      </p>
      <p>
      ...
      <Card
        description="Uses the shared auth session APIs for the signed-in vendor user."
        title="Your sessions"
      >
        ...
        {sessionsQuery.error ? (
          <p style={{ color: 'var(--color-error)' }}>Unable to load vendor sessions right now.</p>
        ) : null}

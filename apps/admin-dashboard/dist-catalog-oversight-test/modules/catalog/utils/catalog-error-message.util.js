...
exports.extractApiErrorCode = exports.mapCatalogErrorCodeToMessage = void 0;
...
const mapCatalogErrorCodeToMessage = (errorCode, fallback) => {
    if (!errorCode) {
        return fallback;
    }
...
exports.mapCatalogErrorCodeToMessage = mapCatalogErrorCodeToMessage;

...
export function SessionsScreen() {
  const sessionsQuery = useDeliverySessions();
  ...
  return (
    <ScreenWrapper>
      ...
      <Text color="secondary">
        Review devices signed in to your delivery account. Secrets are never shown here.
      </Text>

      <View style={styles.actions}>
        <Button
          accessibilityLabel="Refresh delivery sessions"
        ...
        />
        <Button
          accessibilityLabel="Log out of other delivery sessions"
      ...
      {sessionsQuery.error ? (
        <Text color="error">Unable to load delivery sessions right now.</Text>
      ) : null}

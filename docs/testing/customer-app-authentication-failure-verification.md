# Customer App Authentication Failure Verification
...
- Request OTP with seeded customer phone
...
- Set seeded customer account status to blocked
- Try login again
- Confirm blocked-account message appears
- Restore seeded customer account status to active
